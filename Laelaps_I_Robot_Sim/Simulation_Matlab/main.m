...
% Link 2
mH2 = 0.5; % link 2 mass
dH2 = 0.07; %0.075; % distance from link's COM to link's joint
...
dH3 = 0.205; %0.075; % distance from link's COM to link's joint
...
% Link 1
mF1 = 0.6; % link 1 mass
dF1 = dH1*cos(Fore_leg_angle); % distance from link's COM to link's joint 
IF1 = IH1; % Set it equal to this of the hind legs
% Link 2
mF2 = 0.5; % link 2 mass
dF2 = dH2*cos(Fore_leg_angle); % distance from link's COM to link's joint
IF2 = IH2; % Set it equal to this of the hind legs
% Link 3
mF3 = 0.23; % link 3 mass
dF3 = dH3*cos(Fore_leg_angle); % distance from link's COM to link's joint
IF3 = IH3; % link 3 moment of inertia
...
bspringF = 1.0; % link 1 (fore leg)
bspringH = 1.0; % link 2 (hind leg)
% Free length
l0H = 0.04;
l0F = l0H*cos(Fore_leg_angle);
